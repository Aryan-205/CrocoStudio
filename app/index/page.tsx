...
// const projects = [
//   { year: '2025', client: 'Samsung', project: 'Galaxy Watch8 Series' },
//   { year: '2025', client: 'Oakley', project: 'Plantaris Titanium' },
//   { year: '2025', client: 'Samsung', project: 'Galaxy Z Fold 7 - BnB' },
//   { year: '2025', client: 'Ray-Ban', project: 'Innovation Lab' },
//   { year: '2025', client: 'Oakley', project: 'Artifacts from the Future' },
//   { year: '2025', client: 'Wolf & Shepherd', project: 'SuperCrossover' },
//   { year: '2025', client: 'Moncler', project: 'Grenoble FW25' },
// ];
...
//   return (
//     <div className="min-h-screen w-full bg-[#E5E5E5] text-black font-sans px-8 py-40 2xl:py-80">
...
//             <div 
//               key={index} 
//               className="grid grid-cols-12 w-full items-baseline group cursor-pointer py-4"
//             >
//               <div className="col-span-3 text-3xl font-medium tracking-tight group-hover:text-[#FF5100] transition-all">
//                 {item.year}
//               </div>
//               <div className="col-span-4 text-3xl font-medium tracking-tight group-hover:text-[#FF5100] transition-all">
//                 {item.client}
//               </div>
//               <div className="col-span-4 text-3xl font-medium tracking-tight group-hover:text-[#FF5100] transition-all">
//                 {item.project}
